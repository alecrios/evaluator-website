	...
	data() {
		return {
			operatingSystems: {
				macos: {
					name: 'macOS',
					link: 'https://github.com/alecrios/evaluator/releases/download/v1.1.0/Evaluator-1.1.0.dmg',
				...
				windows: {
					name: 'Windows',
					link: 'https://github.com/alecrios/evaluator/releases/download/v1.1.0/Evaluator.1.1.0.exe',
