	...
	data() {
		return {
			operatingSystems: {
				macos: {
					name: 'macOS',
					link: 'https://github.com/alecrios/evaluator/releases/download/v1.0.0/Evaluator-1.0.0.dmg',
				...
				windows: {
					name: 'Windows',
					link: 'https://github.com/alecrios/evaluator/releases/download/v1.0.0/Evaluator.1.0.0.exe',
